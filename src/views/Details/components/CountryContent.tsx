...
function CountryContent({countryState}: Props) {
    ...
    return (
        <div className="grid grid-cols-2 max-xl:grid-cols-1 max-xl:gap-4 dark:text-slate-100">
            ...
            <div className="py-4 flex flex-col justify-between">
                ...
                <div className="my-4 flex max-md:flex-col gap-20 max-md:gap-8 ">
                ...
                <div className="flex max-md:flex-col gap-4 md:items-center max-md:mt-4">
                    ...
                    <ul className="flex flex-wrap gap-4 ">
                        {
                            !borders
                                ...
                                borders.map((border: string) => (
                                    <li key={border}
                                        className="bg-white drop-shadow-md p-1 px-4 dark:bg-[#1B2E3B] dark:text-slate-100 ">{border}</li>
                                ))
                        }
                    </ul>
